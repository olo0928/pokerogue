...
export const modifierTypes = {
  ...
  HEALING_CHARM: () => new ModifierType("modifierType:ModifierType.HEALING_CHARM", "healing_charm", (type, _args) => new Modifiers.HealingBoosterModifier(type, 1.2)),
...
const modifierPool: ModifierPool = {
  ...
  [ModifierTier.MASTER]: [
    ...
    new WeightedModifierType(modifierTypes.VOUCHER_PREMIUM, (party: Pokemon[], rerollCount: integer) =>
      !party[0].scene.gameMode.isDaily && !party[0].scene.gameMode.isEndless && !party[0].scene.gameMode.isSplicedOnly ? Math.max(10 - rerollCount * 1, 8) : 0, 10),
